...
public class DialogEditFertilization extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(view).setTitle("Edytuj wpis").setNegativeButton("Anuluj", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                listener.changeTextsFertilization(category, id, fieldId, plant, chemicals, dose, developmentPhase, date, info);
            }
        });
    ...
    public interface DialogEditListener {
        void changeTextsFertilization(String category,String id, String fieldId, String plant, String chemicals, String dose, String developmentPhase, String date, String info);
    }
