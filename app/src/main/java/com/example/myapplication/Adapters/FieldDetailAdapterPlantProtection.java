...
public class FieldDetailAdapterPlantProtection extends RecyclerView.Adapter<FieldDetailAdapterPlantProtection.ViewHolder> {

    public ArrayList<FieldsDetailPlantProtection> fieldsDetailsArrayList = new ArrayList<>();
    String category;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FieldDetailAdapterPlantProtection.ViewHolder(cardView);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        FieldsDetailPlantProtection fieldsDetail = fieldsDetailsArrayList.get(position);
