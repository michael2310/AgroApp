...
public class FieldDetailAdapterFertilization extends RecyclerView.Adapter<FieldDetailAdapterFertilization.ViewHolder> {

    public ArrayList<FieldsDetailFertilization> fieldsDetailsArrayList = new ArrayList<>();
    String category;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FieldDetailAdapterFertilization.ViewHolder(cardView);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        FieldsDetailFertilization fieldsDetail = fieldsDetailsArrayList.get(position);
