...
public class DialogFieldDetail extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(view).setTitle("Dodaj wpis").setNegativeButton("Anuluj", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                listener.applyTexts(plant, chemia, dose, developmentPhase, date, info, category);
            }
        });
    ...
    public interface DialogListener{
        void applyTexts(String plant, String chemia, String dose, String developmentPhase, String date, String info, String category);
    }
}
