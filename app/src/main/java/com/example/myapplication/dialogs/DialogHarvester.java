...
public class DialogHarvester extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(view).setTitle("Dodaj maszynę").setNegativeButton("Anuluj", (dialog, which) -> {
            ...
            String category = "Harvester";
            listener.applyTextsHarvester(brand, model, category);
        });
    ...
    public interface DialogListener {
        void applyTextsHarvester(String brand, String model, String category);
    }
}